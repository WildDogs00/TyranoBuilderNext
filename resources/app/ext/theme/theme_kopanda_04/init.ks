...
mp.font_color2   = mp.font_color2   || "0x665555";
...
;名前枠の設定
[ptext name="chara_name_area" layer="message0" color="&mp.name_color" size=26 bold="true" x=10 y=427 width="330" align="center"]
...
;クイックセーブボタン
[button name="role_button" role="quicksave" graphic="../others/plugin/theme_kopanda_04/image/button/qsave.png" enterimg="../others/plugin/theme_kopanda_04/image/button/qsave2.png" x=110 y=600]

;クイックロードボタン
[button name="role_button" role="quickload" graphic="../others/plugin/theme_kopanda_04/image/button/qload.png" enterimg="../others/plugin/theme_kopanda_04/image/button/qload2.png" x=192 y=600]

;セーブボタン
[button name="role_button" role="save" graphic="../others/plugin/theme_kopanda_04/image/button/save.png" enterimg="../others/plugin/theme_kopanda_04/image/button/save2.png" x=280 y=600]

;ロードボタン
[button name="role_button" role="load" graphic="../others/plugin/theme_kopanda_04/image/button/load.png" enterimg="../others/plugin/theme_kopanda_04/image/button/load2.png" x=340 y=600]

;スキップボタン
[button name="role_button" role="skip" graphic="../others/plugin/theme_kopanda_04/image/button/skip.png" enterimg="../others/plugin/theme_kopanda_04/image/button/skip2.png" x=405 y=602]

;オートボタン
[button name="role_button" role="auto" graphic="../others/plugin/theme_kopanda_04/image/button/auto.png" enterimg="../others/plugin/theme_kopanda_04/image/button/auto2.png" x=460 y=600]
...
;=================================================================================
[loadjs storage="plugin/theme_kopanda_04/testMessagePlus/gMessageTester.js"]
[loadcss file="./data/others/plugin/theme_kopanda_04/testMessagePlus/style.css"]
