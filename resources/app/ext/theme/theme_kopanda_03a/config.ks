...
;=========================================
	...
	/* 画像類のパス */
	tf.img_path     = '../others/plugin/theme_kopanda_03a/image/config/';
	...
	tf.img_path_bgmmute = tf.img_path + 'c_set_bgm0.png';
	tf.img_path_semute  = tf.img_path + 'c_set_se0.png';

	tf.img_path_skip_on  = tf.img_path + 'c_uts_on.png';
	tf.img_path_skip_off = tf.img_path + 'c_uts_off.png';

	// チェック画像の座標
	tf.config_x = [870,  45, 100, 155, 210, 265, 320, 375, 430, 485, 540];
	tf.config_y = [180, 310, 450, 590];
...
;	画面右上の「Back」ボタン
	[button fix="true" target="*backtitle" graphic="&tf.img_path + 'c_btn_back.gif'" enterimg="&tf.img_path + 'c_btn_back2.gif'" x="550" y="10"]
...
;	BGM音量-ミュート（音量=0）
	[button name="bgmvol, bgmvol_0"   fix="true" target="*vol_bgm_mute" graphic="&tf.btn_path_off" width="120" height="35" x="470" y="135"]
...
;	SEミュート
	[button name="sevol,sevol_0"   fix="true" target="*vol_se_mute" graphic="&tf.btn_path_off" width="120" height="35" x="470" y="265"]
...
;------------------------------------------------------------------------------------------------------
;	未読スキップ-OFF
	[button name="unread_off" fix="true" target="*skip_off" graphic="&tf.btn_path_off" width="220" height="50" x="90"  y="730"]

;	未読スキップ-ON
	[button name="unread_on"  fix="true" target="*skip_on"  graphic="&tf.btn_path_off" width="220" height="50" x="325" y="730"]
...
*load_bgm_img
	...
	[image layer="0" name="bgmvol" storage="&tf.img_path_bgmmute" x="470" y="135"]
	[else]
...
*load_se_img
	...
	[image layer="0" name="sevol"  storage="&tf.img_path_semute" x="470" y="265"]
	[else]
...
*load_skip_img
	...
	[image layer="0" name="skip" storage="&tf.img_path_skip_on"  x="325" y="730"]
	[else]
	[image layer="0" name="skip" storage="&tf.img_path_skip_off" x="90" y="730"]
	[endif]
[return]
