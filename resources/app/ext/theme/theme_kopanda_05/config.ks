...
;=========================================
	...
	/* 画像類のパス */
	tf.img_path     = '../others/plugin/theme_kopanda_05/image/config/';
	tf.btn_path_off = tf.img_path + 'c_btn.gif';
	tf.btn_path_on1 = tf.img_path + 'c_set1.png';
	tf.btn_path_on2 = tf.img_path + 'c_set2.png';

	tf.img_path_skip_on   = tf.img_path + 'c_uts_on.png';
	tf.img_path_skip_off  = tf.img_path + 'c_uts_off.png';
	tf.img_path_skip_on2  = tf.img_path + 'c_uts_on2.png';
	tf.img_path_skip_off2 = tf.img_path + 'c_uts_off2.png';


	// チェック画像の座標
	tf.config_x = [810, 300, 345, 390, 435, 480, 525, 570, 615, 660, 705];
	tf.config_y = [200, 250, 320, 370];
...
;	画面右上の「Back」ボタン
	[button fix="true" graphic="&tf.img_path + 'c_button_back.png'" enterimg="&tf.img_path + 'c_button_back2.png'" target="*backtitle" x="840" y="80"]
...
;------------------------------------------------------------------------------------------------------
;	未読スキップ-OFF
	[button name="unread_off" fix="true" target="*skip_off" graphic="&tf.btn_path_off" width="125" height="35" x="300" y="440"]

;	未読スキップ-ON
	[button name="unread_on"  fix="true" target="*skip_on"  graphic="&tf.btn_path_off" width="125" height="35" x="435" y="440"]
...
*load_skip_img
	...
	[image layer="0" name="skip" storage="&tf.img_path_skip_on2"  x="435" y="440"]
	[else]
	[image layer="0" name="skip" storage="&tf.img_path_skip_off2" x="300" y="440"]
	[endif]
	[return]
