	...
	tf.img_path = '../others/plugin/NVE_Default_theme_1280/image/config/';
...
[cm]
	...
	[button fix="true" graphic="&tf.img_path + 'c_btn_back.png'" enterimg="&tf.img_path + 'c_btn_back2.png'" target="*backtitle" x="1118" y="20"]
...
;	SE
	...
	if(tf.text_skip == 'OFF'){
		$(".unread_off").attr("src","data/others/plugin/NVE_Default_theme_1280/image/config/c_skipoff_h.png");
		$(".unread_on").attr("src","data/others/plugin/NVE_Default_theme_1280/image/config/c_skipon.png");
		}else{
			$(".unread_on").attr("src","data/others/plugin/NVE_Default_theme_1280/image/config/c_skipon_h.png");
			$(".unread_off").attr("src","data/others/plugin/NVE_Default_theme_1280/image/config/c_skipoff.png");
			}
	[endscript]
