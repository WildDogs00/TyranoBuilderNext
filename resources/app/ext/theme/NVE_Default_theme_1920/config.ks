	...
	tf.img_path = '../others/plugin/NVE_Default_theme_1920/image/config/';
	...
	tf.config_x       = [1559, 599, 680, 760, 840, 920, 1001, 1081, 1164, 1246, 1326];

	tf.config_y_bgm   = 284;
	tf.config_y_se    = 375;
	tf.config_y_ch    = 486;
	tf.config_y_auto  = 578;
...
[cm]
	...
	[button fix="true" graphic="&tf.img_path + 'c_btn_back.png'" enterimg="&tf.img_path + 'c_btn_back2.png'" target="*backtitle" x="1667" y="20"]
...
;	SE
	...
	[button name="unread_off" fix="true" target="*skip_off" graphic="&tf.btn_path_off" width="258" height="79" x="870" y="700"]

	[button name="unread_on"  fix="true" target="*skip_on"  graphic="&tf.btn_path_off" width="258" height="79" x="600" y="700"]

	[iscript]

	$(".bgmvol_"+tf.current_bgm_vol).attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_set.png");

	$(".sevol_"+tf.current_se_vol).attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_set.png");

	$(".ch_"+tf.current_ch_speed).attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_set.png");

	$(".auto_"+tf.current_auto_speed).attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_set.png");

	if(tf.text_skip == 'OFF'){
		$(".unread_off").attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_skipoff_h.png");
		$(".unread_on").attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_skipon.png");
		}else{
			$(".unread_on").attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_skipon_h.png");
			$(".unread_off").attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_skipoff.png");
			}
	[endscript]
...
*ch_speed_change
	...
	$(".ch_"+tf.set_ch_speed).attr("src","data/others/plugin/NVE_Default_theme_1920/image/config/c_set.png");
	...
	[position layer="message1" left="200" top="880" width="1100" height="100" margint="2" marginl="30" page="fore" visible="true" opacity="0"]
	[layopt layer="message1" visible="true"]
	[current layer="message1"]

	[emb exp="tf.text_sample"]
		[iscript]
		$(".current_span").css("color","#dedede");
